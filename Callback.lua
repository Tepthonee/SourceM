...
msalm = "↢ وسوينا لك حساب في بنك شهد\n↢ وشحنالك ٥٠ درهم 💸 هديه\n\n↢ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n↢ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n↢ فلوسك ↤ ❲ 50 ريال 💸 ❳\n↢ شخصيتك ↤ "..shakseshakse.."\n↢ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"↢ تم الغاء شراء اللاعب شهد سواريز ", 'md', true)
end
end
